@local @local_quizanon @local_quizanon_grading
Feature: Basic use of the Manual grading anon report
  In order to easily find students attempts that need manual anon grading
  As a teacher
  ...
  Scenario: Teacher can see user custom filed columns as additional user identity
    ...
    And I follow "Also show questions that have been graded automatically"
    And I click on "update grades" "link" in the "Short answer 001" "table_row"
    Then I should see "Attempt number 1 for"
  ...
  Scenario: Manual grading report with attempts to be graded
    ...
    # Adjust the mark for Student1s
    And I set the field "Comment" to "I have adjusted your mark to 0.6"
    And I set the field "Mark" to "0.6"
    And I should see "This is my attempt 1"
    And I press "Save and show next"
    And I should see "This is my attempt 2"
    And I press "Save and show next"
    And I should see "This is my attempt 3"
